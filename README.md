...
A tool helps to pack BME assets into a zip file.

Powered by [Vite](https://vite.dev/), [Electron](https://www.electronjs.org/) and [React](https://react.dev/).
...
- A set of assets can be saved as a formula.
...
[![](https://img.shields.io/github/license/Withered-Flower-0422/bme-asset-packager)](https://github.com/Withered-Flower-0422/bme-asset-packager/blob/main/LICENSE)

Copyright 2026-present Withered Flower.
